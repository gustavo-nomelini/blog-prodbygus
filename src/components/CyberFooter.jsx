              ...
              <ul className="space-y-3">
                <li>
                  ...
                  >
                    ...
                    {/* Full email shown only on desktop */}
                ...
                <li>
                  ...
                  >
                    ...
                    {/* Full phone number shown only on desktop */}
                    <span className="hidden md:inline">+55 (45) 99850-8634</span>
                  </a>
                </li>
                <li className="text-sm text-[var(--text-muted)] cyber-text">
                  <span className="text-[var(--primary)]">⌖ </span>
                  <span className="hidden md:inline">Cascavel - PR, Brasil</span>
                  <span className="md:hidden">Cascavel, BR</span>
                </li>
              </ul>
            </div>
          </div>
